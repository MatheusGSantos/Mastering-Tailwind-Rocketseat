export function Logo() {
  return (
    <strong className="mx-1 flex items-center gap-2 text-xl font-semibold text-zinc-900">
      ...
      >
        <g filter="url(#filter0_dd_19001_307)">
          <g clipPath="url(#clip0_19001_307)">
            ...
            <rect
              ...
              height={32}
              rx={8}
              fill="url(#paint0_linear_19001_307)"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            <path
              ...
              fill="#D0D5DD"
            />
            <g filter="url(#filter1_dd_19001_307)">
              <circle
                cx={19}
                cy={18}
                r={8}
                fill="url(#paint1_linear_19001_307)"
              />
            </g>
            <g filter="url(#filter2_b_19001_307)">
              <path
